...
/**
 * serves as DAO, as well as PAO (process access object). In the latter case,
 * this should be used only in cases, when explicit access to process is
 * required, but working with -wrapper- objects (e.g. ProcessDefinitionW),
...
public interface BPMDAO extends GenericDao {
	...
	public abstract ViewTaskBind getViewTaskBindByTaskInstance(
			long taskInstanceId, String viewType);

	public abstract List<ViewTaskBind> getViewTaskBindsByTaskId(long taskId);

	public abstract List<ViewTaskBind> getViewTaskBindsByTaskInstanceId(
			long taskInstanceId);
	...
	public abstract void updateAddGrpsToRole(Long roleActorId,
			Collection<String> selectedGroupsIds);

	public abstract List<NativeIdentityBind> getNativeIdentities(
	...
	public abstract void updateCreateProcessRoles(Collection<Role> rolesNames,
			Long processInstanceId);

	public abstract List<Object[]> getProcessTasksViewsInfos(
	...
	public abstract List<ProcessInstance> getSubprocessInstancesOneLevel(
